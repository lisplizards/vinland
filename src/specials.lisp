...
(defparameter *request* nil
  "The LACK/REQUEST:REQUEST object representing the current request; dynamically bound.")

(defparameter *response* nil
  "The LACK/RESPONSE:RESPONSE object representing the response to return; dynamically bound.")
...
keyword as the cons CAR and the value as the CDR; dynamically bound.")
